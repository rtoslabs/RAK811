...
void SystemClockConfig( void )
{
    ...
    RCC_OscInitStruct.OscillatorType = RCC_OSCILLATORTYPE_HSI | RCC_OSCILLATORTYPE_LSE; // modify  RCC_OSCILLATORTYPE_HSE to RCC_OSCILLATORTYPE_HSI
    RCC_OscInitStruct.HSEState = RCC_HSI_ON;   //modify RCC_HSE_ON to RCC_HSI_ON
    RCC_OscInitStruct.LSEState = RCC_LSE_ON;
    RCC_OscInitStruct.PLL.PLLState = RCC_PLL_OFF;   // Disabled PLL
